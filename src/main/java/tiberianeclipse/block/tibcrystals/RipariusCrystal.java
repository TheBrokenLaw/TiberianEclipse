...
public class RipariusCrystal extends TiberiumGrowth {
    public int meta;
    ...
    public RipariusCrystal(String name, Material material, Item drop, int meta, int leastQuantity, int mostQuantity, float hardness, float resistance, float lightLevel, boolean whatthefuck) {
