...
public class ViniferaCrystal extends TiberiumGrowth {
    public int meta;
    ...
    public ViniferaCrystal(String name, Material material, Item drop, int meta, int leastQuantity, int mostQuantity, float hardness, float resistance, float lightLevel, boolean whatthefuck) {
...
public void updateTick(World worldIn, BlockPos pos, IBlockState state, Random rand) {
    ...
    if (rand.nextInt(10) == 0)
    {
        ...
        if (worldIn.isAirBlock(blockpos1) && this.canBlockStay(worldIn, blockpos1, this.getDefaultState())||worldIn.getBlockState(blockpos1)==ModBlocks.ripariusPod.getDefaultState())
        {
