...
public class ModBiomeManager extends BiomeManager {
    ...
    private static TrackedList<BiomeEntry>[] setupBiomes()
    {
        ...
        currentBiomes[BiomeType.BLUE.ordinal()] = new TrackedList<BiomeEntry>(list);
        list.clear();

        currentBiomes[BiomeType.YELLOW.ordinal()] = new TrackedList<BiomeEntry>(list);
        list.clear();

        currentBiomes[BiomeType.RED.ordinal()] = new TrackedList<BiomeEntry>(list);
        list.clear();
    ...
    {
        DESERT, WARM, COOL, ICY, BLUE, YELLOW, RED;
