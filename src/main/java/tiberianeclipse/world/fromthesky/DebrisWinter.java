...
public class DebrisWinter extends DebrisDoubler {
    private final BlockPlacer placer;
    public DebrisWinter(final ItCameFromSpace world, final int x, final int y, final int z, final BlockPlacer placer, final BlockIs starTibDef){
    ...
    public void getRandImpact(final ItCameFromSpace world, final int x, final int y, final int z){
        ...
        if(rand>1.0){
            ...
            this.placer.place(world, x, y, z, Blocks.SNOW);
        }
    }
