...
public class Record extends ItemBase{
    private static final Map<SoundEvent, Record> RECORDS = Maps.<SoundEvent, Record>newHashMap();
    private final SoundEvent sound;
    private final String displayName;

    protected Record(String name, SoundEvent soundIn)
    {
        super(name,0);
    ...
    @Nullable
    @SideOnly(Side.CLIENT)
    public static Record getBySound(SoundEvent soundIn)
    {
        return (Record)RECORDS.get(soundIn);
    }
